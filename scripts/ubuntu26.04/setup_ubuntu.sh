...
#!/usr/bin/env bash
# Script created for Ubuntu 26.04
# To execute run:
# sudo apt install curl ; curl -fsSL https://raw.githubusercontent.com/pedroeloy/ubuntu/refs/heads/main/scripts/ubuntu26.04/setup_ubuntu.sh | bash
